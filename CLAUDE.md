...
This project is indexed by GitNexus as **streamplan-react95** (193 symbols, 261 relationships, 9 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
